...
const FAQ_SLOTS = [
  { id: 5640, contentId: "dee5221", headingId: "0218b9d" },
  { id: 5641, contentId: "6c09af6", headingId: "47c9b05" },
  { id: 5642, contentId: "ab93070", headingId: "bc36a8a" },
  { id: 5643, contentId: "1cf0821", headingId: "f7b8af9" },
  { id: 5644, contentId: "6751bc4", headingId: "e42f3ee" },
] as const;

export default function FAQ() {
  const { faqs, faqHeading, faqSubheading } = useSaasContent();
  ...
  return (
    <div
      className="elementor-element elementor-element-f27caac e-flex e-con-boxed e-con e-parent"
      data-id="f27caac"
    ...
    >
      <div className="e-con-inner">
        <div
          className="elementor-element elementor-element-8d7c43e e-con-full e-flex elementor-invisible e-con e-child"
          data-id="8d7c43e"
          data-element_type="container"
          data-settings='{"animation":"fadeInUp","animation_delay":50}'
        >
          <div
            className="elementor-element elementor-element-378d043 elementor-widget elementor-widget-heading"
            data-id="378d043"
            data-element_type="widget"
          >
            <div className="elementor-widget-container">
              <h2 className="elementor-heading-title elementor-size-default">{faqHeading}</h2>
            </div>
          </div>
          <div
            className="elementor-element elementor-element-43739c9 elementor-widget__width-initial elementor-widget-mobile__width-inherit elementor-widget elementor-widget-heading"
            data-id="43739c9"
            data-element_type="widget"
          >
            <div className="elementor-widget-container">
              <p className="elementor-heading-title elementor-size-default">{faqSubheading}</p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="elementor-widget-container">
            <div className="e-n-accordion" aria-label="Accordion">
              {FAQ_SLOTS.map((slot, index) => {
                const faq = faqs[index] || faqs[0];
                return (
                  <details
                    key={slot.id}
                    id={`e-n-accordion-item-${slot.id}`}
                  ...
                  >
                    <summary
                      ...
                      aria-controls={`e-n-accordion-item-${slot.id}`}
                    >
                    ...
                    <div
                      role="region"
                      aria-labelledby={`e-n-accordion-item-${slot.id}`}
                      className={`elementor-element elementor-element-${slot.contentId} e-con-full e-flex e-con e-child`}
                      data-id={slot.contentId}
                      data-element_type="container"
                    >
                      <div
                        className={`elementor-element elementor-element-${slot.headingId} elementor-widget elementor-widget-heading`}
                        data-id={slot.headingId}
                        data-element_type="widget"
                      >
                        <div className="elementor-widget-container">
