  ...
  return (
    <div className="elementor-element elementor-element-8506b09 e-flex e-con-boxed e-con e-parent" data-id="8506b09" data-element_type="container" data-settings='{"background_background":"classic"}'>
      <div className="e-con-inner">
        ...
        {/* Workflow Step 1 */}
        <div className="elementor-element elementor-element-ae7562e e-con-full e-flex elementor-invisible e-con e-child" data-id="ae7562e" data-element_type="container" data-settings='{"animation":"fadeInUp"}'>
          <div className="elementor-element elementor-element-a15a8bc e-con-full e-flex e-con e-child" data-id="a15a8bc" data-element_type="container">
            ...
            <div className="elementor-element elementor-element-9f1e4d7 elementor-position-left icn-align elementor-mobile-position-left elementor-view-default elementor-widget elementor-widget-icon-box" data-id="9f1e4d7" data-element_type="widget">
              <div className="elementor-widget-container">
                <div className="elementor-icon-box-wrapper">
                  <div className="elementor-icon-box-icon">
                    <span className="elementor-icon">
        ...
        {/* Workflow Step 2 */}
        <div className="elementor-element elementor-element-affd21a e-con-full e-flex elementor-invisible e-con e-child" data-id="affd21a" data-element_type="container" data-settings='{"animation":"fadeInUp"}'>
          <div className="elementor-element elementor-element-37b7bcf e-con-full e-flex e-con e-child" data-id="37b7bcf" data-element_type="container">
            ...
            <div className="elementor-element elementor-element-876c23e elementor-position-left icn-align elementor-mobile-position-left elementor-view-default elementor-widget elementor-widget-icon-box" data-id="876c23e" data-element_type="widget">
              <div className="elementor-widget-container">
                <div className="elementor-icon-box-wrapper">
                  <div className="elementor-icon-box-icon">
                    <span className="elementor-icon">
        ...
        {/* Workflow Step 3 - Add remaining steps following same pattern */}
        <div className="elementor-element elementor-element-ec80448 e-con-full e-flex elementor-invisible e-con e-child" data-id="ec80448" data-element_type="container" data-settings='{"animation":"fadeInUp"}'>
          <div className="elementor-element elementor-element-1317c94 e-con-full e-flex e-con e-child" data-id="1317c94" data-element_type="container">
            ...
            <div className="elementor-element elementor-element-d7bc2d3 elementor-position-left icn-align elementor-mobile-position-left elementor-view-default elementor-widget elementor-widget-icon-box" data-id="d7bc2d3" data-element_type="widget">
              <div className="elementor-widget-container">
                <div className="elementor-icon-box-wrapper">
                  <div className="elementor-icon-box-icon">
                    <span className="elementor-icon">
        ...
        {/* Workflow Step 4 */}
        <div className="elementor-element elementor-element-dc4f476 e-con-full e-flex elementor-invisible e-con e-child" data-id="dc4f476" data-element_type="container" data-settings='{"animation":"fadeInUp"}'>
          <div className="elementor-element elementor-element-6a00489 e-con-full e-flex e-con e-child" data-id="6a00489" data-element_type="container">
            ...
            <div className="elementor-element elementor-element-b84eb4a elementor-position-left icn-align elementor-mobile-position-left elementor-view-default elementor-widget elementor-widget-icon-box" data-id="b84eb4a" data-element_type="widget">
              <div className="elementor-widget-container">
                <div className="elementor-icon-box-wrapper">
                  <div className="elementor-icon-box-icon">
                    <span className="elementor-icon">
